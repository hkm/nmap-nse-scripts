...
Stores the results of an HTTP(S) scan on a HTML page with JQuery. Shows IP, header, realm and tries to identfy if target is a router, camera or common web server.
